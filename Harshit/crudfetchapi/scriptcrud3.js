...
const valueofData=()=> {
  ...
  if(fname===""){
    document.getElementById('p1').innerHTML="Please enter first name";
  }
  else if(lname===""){
    document.getElementById('p2').innerHTML="Please enter last name";
  }
  else if(sname === ""){
    document.getElementById('p3').innerHTML="Please enter surname";
  }
  else if(email === ""){
    document.getElementById('p4').innerHTML="Please enter email";
  }
  else if (phonumber === ""){
    document.getElementById('p5').innerHTML="Please enter phone number";
  }
  else if (country === ""){
    document.getElementById('p6').innerHTML="Please enter country";
  }
  else if (state === ""){
    document.getElementById('p7').innerHTML="Please enter state";
  }
  else if (city === ""){
    ...
    document.getElementById('p9').innerHTML="Please enter your hoby"
  }
  else if (gendaerid.length == 0){
    document.getElementById('p10').innerHTML="Please enter your gender"
  }
...
const editform=(i)=>{
  ...
  <div class="pb-3" >
          ...
          <div class="pb-3">
            <label>Country:</label>
            <select class="form-select" id="country" onchange="selectHandel()">
  ...
  document.getElementById("country").value = data[i].newcountry;

  const newcountry = data[i].formecountry;
  console.log(".....1",newcountry);
  if (newcountry == "data[i].formecountry"){
    document.getElementById("country").value = "data[i].formecountry";}
...
const country_state_name = [];

const countryname =() =>{

const countriestateapi = "https://countriesnow.space/api/v0.1/countries/states";
...
fetch(countriestateapi,{header})
  .then((result) => result.json())
  .then((result) => {
    // console.log(result.data);
    
    country_state_name.push(...result.data)
    document.getElementById('country').innerHTML = result.data.map((value)=>{
...
const selectHandel = () =>{
  const countrychangename = document.getElementById('country').value;
  document.getElementById('state').innerHTML = country_state_name.find((value)=>{
    return value.name === countrychangename;
  }).states.map((v)=>{
